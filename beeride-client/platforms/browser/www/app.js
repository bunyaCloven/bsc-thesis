 ...
 */
window.serverAddress = "http://192.168.1.106:8080";
window.requires = [ 'Ext.MessageBox', 'Beeride.util.Auth', 'Beeride.util.Ajax',
...
Ext.application({
  ...
  onUpdated : function() {
    Ext.Msg.confirm("Application Update", "Application Updated. Reload now?",
        function(buttonId) {
          if (buttonId === 'yes') {
